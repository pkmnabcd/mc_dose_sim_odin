...
# Progress
Right now, I'm just starting out in the planning phase.
Some of my first priorities are the following.
* Figure out the general design of the program
* Learn the Odin programming language
* Choose a graphics API and learn it
* Learn the physics involved in this simulation
