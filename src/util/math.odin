...
/*
This function will interpolate between the given linear attenuation data
and get the best matching linear attenuation coefficients.

Inputs:
- attenuation_data: the linear attenuation data from xcom that needs to be interpolated
